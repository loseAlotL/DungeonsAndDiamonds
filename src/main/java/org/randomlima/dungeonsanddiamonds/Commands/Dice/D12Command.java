...
public class D12Command implements CommandExecutor {
    private final DungeonsAndDiamonds plugin;
    DiceStuff diceStuff;
    public D12Command(DungeonsAndDiamonds plugin){
        this.plugin = plugin;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        if(sender instanceof Player) diceStuff.tellDieRolls((Player) sender,12,24);
        return true;
    }
}