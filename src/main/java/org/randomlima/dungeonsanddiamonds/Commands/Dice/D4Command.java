...
public class D4Command implements CommandExecutor {
    private final DungeonsAndDiamonds plugin;
    DiceStuff diceStuff;
    public D4Command(DungeonsAndDiamonds plugin){
        this.plugin = plugin;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        if(sender instanceof Player) diceStuff.tellDieRolls((Player) sender,4,10);
        return true;
    }
}
